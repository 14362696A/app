...
void main() async {
  ...
  await Supabase.initialize(
    ...
    anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imt0cXBmcGVscHNxY2d3d3pvdXlwIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQ1NjgyMjMsImV4cCI6MjA2MDE0NDIyM30.ENPXIn3c1COhsW1EG2PNTRkuxShITPO5xhPdC3QP4TQ',
  );
  ...
  Future<void> login() async {
    ...
    try {
      ...
      if (response.user != null) {
        ...
        // Redirecionar para a próxima tela (ex: ensalamento)
      } else {
        ScaffoldMessenger.of(context).showSnackBar(
